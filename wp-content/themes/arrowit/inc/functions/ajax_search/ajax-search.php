<?php
add_action( 'wp_ajax_arrowit_search', 'arrowit_autocomplete_search' );
add_action( 'wp_ajax_nopriv_arrowit_search', 'arrowit_autocomplete_search' );
function arrowit_autocomplete_search() {
