...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="woocommerce-grouped-product-list group_table">
		<thead>
			<tr>
				<th class="product-name"><h4><?php echo esc_html__('Product Name','arrowit'); ?></h4></th>
				<th class="product-qty"><h4><?php echo esc_html__('Qty','arrowit'); ?></h4></th>
			</tr>
		</thead>
		<tbody>
			<?php
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt"><?php echo esc_html( $product->single_add_to_cart_text() ); ?> <i class="fas fa-long-arrow-alt-right"></i></button>
