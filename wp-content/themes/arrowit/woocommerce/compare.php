...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_attr($this->stylesheet_url()); ?>" />
...
<h1>
    <?php echo esc_attr( $localized_table_text ); ?>
    <?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php _e( 'Close window [X]', 'arrowit' ) ?></a><?php endif; ?>
</h1>
...
<div id="yith-woocompare" class="woocommerce">
    ...
    <?php if ( empty( $products ) ) : ?>
        ...
        <tr class="no-products">
            <td><?php _e( 'No products added in the compare table.', 'arrowit' ) ?></td>
        </tr>
        ...
        <tr class="remove">
            ...
            foreach( $products as $product_id => $product ) :
                ...
                <td class="<?php echo esc_attr( $product_class ); ?>">
                    <a href="<?php echo add_query_arg( 'redirect', 'view', $this->remove_product_url( $product_id ) ) ?>" data-product_id="<?php echo wp_kses_post($product_id); ?>"><?php _e( 'Remove', 'arrowit' ) ?> <span class="remove">x</span></a>
                </td>
                <?php
                ++$index;
            endforeach;
