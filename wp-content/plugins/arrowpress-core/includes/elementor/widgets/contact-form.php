...
if(class_exists('WooCommerce')){
    class Apr_Core_Contact_Form extends Widget_Base
    {
        ...
        protected function register_general_content_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors'   => [
                        '{{WRAPPER}} .apr-cf7-style input:not([type=submit]), {{WRAPPER}} .apr-cf7-style select,{{WRAPPER}} .apr-cf7-style textarea' => 'border-style: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'selectors'  => [
                        '{{WRAPPER}} .apr-cf7-style input:not([type=submit]), {{WRAPPER}} .apr-cf7-style select,{{WRAPPER}} .apr-cf7-style textarea' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors'  => [
                        '{{WRAPPER}} .apr-cf7-style input:not([type="submit"]), {{WRAPPER}} .apr-cf7-style select, {{WRAPPER}} .apr-cf7-style textarea' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'default'    => [
                        'top'    => '0',
                        'bottom' => '0',
        ...
        protected function register_button_content_controls() {
            ...
            $this->add_responsive_control(
                'cf7_button_text_trans',
                [
                    'label'      => __( 'Text Transform', 'apr-core' ),
                    'type'       => Controls_Manager::SELECT,
                    'default'    => 'none',
                    'options'      => [
                        'none'       => __( 'None', 'apr-core' ),
                        'capitalize' => __( 'Capitalize', 'apr-core' ),
                        'uppercase' => __( 'Uppercase', 'apr-core' ),
                        'lowercase' => __( 'Lowercase', 'apr-core' ),
                    ],
                    'selectors'  => [
                        '{{WRAPPER}} .apr-cf7 .wpcf7-form .form-submit input[type="submit"]' => 'text-transform: {{VALUE}};',
                    ],
                    'separator'  => 'after',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'   => '',
                    'selectors' => [
                        '{{WRAPPER}} .apr-cf7-style .wpcf7 form.wpcf7-form:not(input) label, {{WRAPPER}} .apr-cf7-style .wpcf7 .wpcf7-list-item-label' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'   => '#c4c4c4',
                    'selectors' => [
                        '{{WRAPPER}}.apr-cf7-style-underline input:not([type=submit]),{{WRAPPER}}.apr-cf7-style-underline select,{{WRAPPER}}.apr-cf7-style-underline textarea' => 'border-color: {{VALUE}};',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'   => '#eaeaea',
                    'selectors' => [
                        '{{WRAPPER}} .apr-cf7-style input:not([type=submit]), {{WRAPPER}} .apr-cf7-style select,{{WRAPPER}} .apr-cf7-style textarea' => 'border-color: {{VALUE}};',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .apr-cf7-style .wpcf7 form input:not([type=submit]):focus, {{WRAPPER}} .apr-cf7-style select:focus, {{WRAPPER}} .apr-cf7-style .wpcf7 textarea:focus' => 'border-color: {{VALUE}};',
                    ],
                    'condition' => [
                        'input_border_style!' => 'none',
                    ],
