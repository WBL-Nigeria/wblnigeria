				...
				<div class="<?php echo esc_attr( $wrap_classes ); ?>">
					...
					<?php if($show_more_post === 'true') :?>
				        <div class="btn-viewmore">
				            <a class="view_more " href="<?php echo esc_url(get_post_type_archive_link($post_type)); ?>"><?php echo esc_html__('View all &nbsp;','apr-core') .'<i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i>';?></a>
				        </div>
				    <?php endif; ?>  
				</div>
			<?php
