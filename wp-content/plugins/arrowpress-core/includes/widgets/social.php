...
if ( ! class_exists( 'Apr_Core_Social_Widget' ) ) {
	class Apr_Core_Social_Widget extends Apr_Widget {
		...
		public function widget( $args, $instance ) {
			...
			$output        = '';
			$show_social   = Arrowit::setting( "show_social" );
			...
			if($desc_title!=''){?>
				...
				echo '<ul class="footer-social-networks">';
					...
					if($google != ''){
						echo '<li class="gg"><a target="_blank" href="'.esc_attr($google) .'"><i class="fab fa-google-plus-g"></i><span class="label">' . esc_html__("Google +", "apr-core") . '</span></a> </li>';
					}
					if($instagram != ''){
					...
					if($pinterest != ''){
						echo '<li class="pin"><a target="_blank" href="'. esc_attr($pinterest). '"><i class="fab fa-pinterest-p" aria-hidden="true"></i><span class="label">' . esc_html__("Pinterest", "apr-core") . '</span></a> </li>';
					}
					if($linkedin != ''){
						echo '<li class="linkedin"><a target="_blank" href="' . esc_attr($linkedin) . '"><i class="fab fa-linkedin"><span class="label">' . esc_html__("Linkedin", "apr-core") . '</span></i></a> </li>';
					}
					if($youtube != ''){
