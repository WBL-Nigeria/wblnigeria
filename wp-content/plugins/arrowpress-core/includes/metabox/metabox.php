...
class Apr_Metabox {
    ...
    public function general_option(){
        $apr_sidebars = Arrowit_Helper::get_registered_sidebars($default_option = true);
        return array(
            ...
            'fields'    => array(
                ...
                array(
                    'id'      => 'arrowit_class',
                    'label'   => esc_attr__( 'Site class', 'apr-core' ),
                    'desc'    => esc_attr__( 'Add class to body', 'apr-core' ),
                    'type'    => 'text',
                    'default' => '',
                ),
                array(
                ...
                array(
                    'id'      => 'scroll_top_horizontal',
                    'label'   => esc_attr__( 'Scroll top position X', 'apr-core' ),
                    'type'    => 'text',
                    'default' => '',
                    'desc'    => esc_attr__( 'Controlling space between scroll-top and the right page', 'apr-core' ),
                ),
                array(
                    'id'      => 'scroll_top_spacer',
                    'label'   => esc_attr__( 'Scroll top position Y', 'apr-core' ),
                    'type'    => 'text',
                    'default' => '',
                    'desc'    => esc_attr__( 'Controlling space between scroll-top and bottom', 'apr-core' ),
                ),
                array(
                    'id'      => 'preload',
    ...
    public function skin_option(){
        return  array(
            ...
            'fields'  => array(
                array(
                    'id'      => 'enable_gradient',
                    'label'   => esc_attr__( 'Enable Gradient', 'apr-core' ),
                    'desc'    => esc_attr__( 'Enable Gradient', 'apr-core' ),
                    'type'    => 'checkbox',
                    'default' => '0',
                ),
                array(
        ...
        return  array(
            ...
            'fields'    => array(
                ...
                array(
                    ...
                    'type'    => 'select',
                    'options' => Arrowit_Helper::get_all_menus(),
                    'default' => '',
                ),
                array(
                    'id'      => 'hide_header',
                ...
                array(
                    ...
                    'desc'    => esc_attr__( 'Switch header builder ON or OFF?', 'apr-core' ),
                    'type'    => 'checkbox',
                    'default' => '',
                ),
        ...
        return  array(
            ...
            'id'     => 'footer','fields'    => array(
                array(
                    ...
                    'options' => array(
                        'default'  => esc_html__( 'Default', 'apr-core' ),
                        '01'  => esc_html__( 'Footer 1', 'apr-core' ),
                        '02'  => esc_html__( 'Footer 2', 'apr-core' ),
                        '03'  => esc_html__( 'Footer 3', 'apr-core' ),
                        '04'  => esc_html__( 'Footer 4', 'apr-core' ),
                        '05'  => esc_html__( 'Footer 5', 'apr-core' ),
                        '06'  => esc_html__( 'Footer 6', 'apr-core' ),
                        '07'  => esc_html__( 'Footer 7', 'apr-core' ),
                        '08'  => esc_html__( 'Footer 8', 'apr-core' ),
                    ),
                    'default' => '',
                ),
                array(
                ...
                array(
                    'id'      => 'footer_top_bg',
                    'label'   => esc_attr__( 'Footer Top Background', 'apr-core' ),
                    'desc'    => esc_html__("Works for footer1, footer2. Go to edit with elementor for footer4, footer7.", 'apr-core'),
                    'type'    => 'color',
                    'default' => '',
                ),
                array(
                    'id'      => 'footer_top_bg_image',
                    'label'   => esc_attr__( 'Footer Top Image Background', 'apr-core' ),
                    'desc'    => esc_html__("Works for footer1, footer2. Go to edit with elementor for footer4, footer7.", 'apr-core'),
                    'type'    => 'image',
                    'default' => '',
                ),
                ...
                array(
                    ...
                    'label'   => esc_attr__( 'Footer button color', 'apr-core' ),
                    'desc'    => esc_html__("You should input hex color(ex: #948e90).", 'apr-core'),
                    'type'    => 'color',
                    'default' => '',
                ),
                array(
                    'id'      => 'footer_button_style_color',
                    'label'   => esc_attr__( 'Footer button style color', 'apr-core' ),
                    'desc'    => esc_html__("You should input hex color(ex: #948e90). Button styling such as circle.", 'apr-core'),
                    'type'    => 'color',
                    'default' => '',
                ),
                array(
                    'id'      => 'footer_button_hover_color',
                    'label'   => esc_attr__( 'Footer button hover color', 'apr-core' ),
                    'desc'    => esc_html__("You should input hex color(ex: #948e90).", 'apr-core'),
                    'type'    => 'color',
                    'default' => '',
                ),
