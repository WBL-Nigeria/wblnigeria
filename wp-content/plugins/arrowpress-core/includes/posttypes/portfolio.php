...
if ( ! class_exists( 'Apr_Core_Portfolio' ) ) {
	class Apr_Core_Portfolio {
		...
		function register_portfolio() {
			...
			if(Arrowit::setting('portfolio_slug')){
	            $portfolio_slug = Arrowit::setting('portfolio_slug');
	        }
	        else {
	        	$portfolio_slug = "portfolio"; 
	        }

	        if(Arrowit::setting('portfolio_cat_slug')){
	            $portfolio_cat_slug = Arrowit::setting('portfolio_cat_slug');
	        }
	        else {
